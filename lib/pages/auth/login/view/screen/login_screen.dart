          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text("Don’t have account?",style: TextStyle(fontSize: 12,fontWeight:FontWeight.w400),),
                  Container(

                    child: GestureDetector(onTap: (){
                      AppRoutes.toregister();
                    },child: Text("  Register",style: TextStyle(fontSize: 12,fontWeight:FontWeight.w400,color: AppColors.primaryDark1),),),
                  )

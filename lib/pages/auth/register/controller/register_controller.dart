...
abstract class RegisterController {
  ...
  String get message;
  void doLogin(String name,String phone);
}

class RegisterControllerImpl extends GetxController implements RegisterController {
  ...
  @override
  void doLogin(String name ,String phone) async {
    try {
      _isButtonDisabled(true);
      _isLoading(true);

      //call api
      AuthResult result = await _auth.authenticate(name: name, phone: phone);
